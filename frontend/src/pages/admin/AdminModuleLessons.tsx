    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-3">
          ...
          <button
            onClick={() => {
              console.log('🔍 [DEBUG] Botón Subir Video clickeado');
              console.log('🔍 [DEBUG] Estado actual showVideoUploader:', showVideoUploader);
              setShowVideoUploader(!showVideoUploader);
              console.log('🔍 [DEBUG] Nuevo estado showVideoUploader:', !showVideoUploader);
            }}
            className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
          >
      ...
      {/* Video Uploader */}
      {(() => {
        console.log('🔍 [DEBUG] Renderizando VideoUploader, showVideoUploader:', showVideoUploader);
        return null;
      })()}
      {showVideoUploader && (
        <div className="bg-white shadow rounded-lg p-6">
