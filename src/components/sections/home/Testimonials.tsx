...
const TestimonialsBackground = () => (
  <div className="minimal-decorations">
    ...
    {/* Partículas flotantes - elementos estáticos */}
    {[...Array(8)].map((_, i) => (
      <div
        key={i}
...
const Testimonials: FC = () => {
  ...
  // Generate star rating without animation
          ...
          >
            {testimonials.map((testimonial, index) => (
              <button
                ...
                onClick={() => setCurrentIndex(index)}
                className={cn(
                  "p-6 rounded-xl text-left transition-all duration-300 border hover:-translate-y-1",
                  index === currentIndex 
